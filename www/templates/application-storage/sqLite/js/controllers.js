...
appControllers.controller('contractListCtrl', function ($scope,$http,$ionicHistory,$state, $stateParams,$filter,$mdToast, $mdDialog, $timeout, $ionicModal, $state, $mdBottomSheet, ContractDB,$cordovaSms) {
    ...
    var request = $http({
        method: "post",
        url: "http://185.33.234.241:8080/content/sendMessage",
...
appControllers.controller('contractDetailCtrl', function ($mdBottomSheet, $mdToast, $scope, $stateParams, $filter, $mdDialog, $ionicHistory, ContractDB, $ionicHistory) {
    ...
    $scope.saveContract = function (contract, $event) {
        ...
        $mdDialog.show({
            ...
            locals: {
                displayOption: {
                    title: "Listeye eklemeyi kabul ediyor musunuz?",
                    content: "Notunuz listeye eklenecektir.",
                    ok: "Kaydet",
                    cancel: "Kapat"
                }
            }
    ...
    $scope.deleteContract = function (contract, $event) {
        ...
        $mdDialog.show({
            ...
            locals: {
                displayOption: {
                    title: "Notu listenizden silmeyi kabul ediyor musunuz?",
                    content: "Not listeden silinecektir.",
                    ok: "Sil",
                    cancel: "Kapat"
                }
            }
