...
appControllers.controller('menuCtrl', function ($scope, $timeout, $mdUtil, $mdSidenav, $log, $ionicHistory, $state,
  $ionicPlatform, $mdDialog, $mdBottomSheet, $mdMenu, $mdSelect) {
    ...
    $ionicPlatform.registerBackButtonAction(function(){
        ...
        if($mdSidenav("left").isOpen()){
            ...
            if($ionicHistory.backView() == null && $ionicHistory.currentStateName()=='app.menuDashboard'){
                ...
                if(jQuery('[id^=dialog]').length == 0 ) {
                    ...
                    $mdDialog.show({
                        ...
                        locals: {
                            displayOption: {
                                title: "Onay",
                                content: "Uygulamayı kapatmak istediğinize emin misiniz?",
                                ok: "Kapat",
                                cancel: "İptal"
                            }
                        }
